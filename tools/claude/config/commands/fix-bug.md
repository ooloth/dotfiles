...
3. **Gather information** - Error messages, stack traces, environment
   - **For recursionpharma repos with CI failures**: Use the `inspecting-codefresh-failures` skill to analyze Codefresh build logs and identify environment differences
...
- For CI failures (recursionpharma): Use the `inspecting-codefresh-failures` skill
