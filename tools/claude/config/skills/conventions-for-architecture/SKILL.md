...
- Parse all incoming data at the I/O boundary
- Transform raw external data structures into ergonomic, expressive, type-safe shapes
...
## Features as pipelines of pure functions with I/O at the edges
