...
5. If a precommit hook fails and addressing the failure requires a design decision the user has not made, stop and present options and wait for approval
6. When finished making all commits, move on to your next approved task immediately (if known) or ask me what's next and do NOT commit again unless specifically asked to do so
