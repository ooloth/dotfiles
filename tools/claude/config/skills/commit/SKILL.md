...
1. Run all checks and fix any errors that weren't autofixed until you see a successful run
2. Run all tests and fix any errors you encounter
...
5. Move on to your next task (if known) or ask me what's next and defer all future committing to me unless I specifically asked you to commit again
