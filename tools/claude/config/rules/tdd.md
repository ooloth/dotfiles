...
2. Pause to let me review and commit
3. Turn exactly one item on the list into an actual, concrete, runnable test
...
6. Pause to let me review and commit
7. Until the list is empty, go back to #2
