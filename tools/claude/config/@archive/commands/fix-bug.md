...
3. **Gather information** - Error messages, stack traces, environment
   - **For recursionpharma repos with CI failures**: Use the `use-codefresh` skill to analyze Codefresh build logs and identify environment differences
...
- For CI failures (recursionpharma): Use the `use-codefresh` skill
