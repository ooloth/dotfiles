# Generated by Powerlevel10k configuration wizard on 2024-05-17 at 17:29 EDT.
...
() {
  ...
  # restarting zsh. Edit ~/.config/powerlevel10k/p10k.zsh and type `source ~/.config/powerlevel10k/p10k.zsh`.
  ...
  # Catppuccin Mocha "mauve": https://github.com/catppuccin/nvim/blob/main/lua/catppuccin/palettes/mocha.lua
  typeset -g POWERLEVEL9K_CONTEXT_{REMOTE,REMOTE_SUDO}_FOREGROUND="#cba6f7"
