...
# Load utilities
# shellcheck source=features/yazi/utils.bash
source "$DOTFILES/features/yazi/utils.bash"

# Load machine detection
# shellcheck source=core/detection/machine.bash
...
main() {
    ...
    if [[ ! -d "$flavors_path/.git" ]]; then
        ...
        echo "   You may need to reinstall: rm -rf '$flavors_path' && ./features/yazi/install.bash"
        return 1
    fi
