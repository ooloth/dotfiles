...
#
# This script:
# 1. Configures general macOS system settings
# 2. Configures Finder preferences
# 3. Configures Safari preferences
...
# Load utilities
source "$DOTFILES/features/settings/utils.bash"
source "$DOTFILES/core/detection/macos.bash"
